...
class TestEventBridgeComplexTypeParser(unittest.TestCase):
    def setUp(self) -> None:
        self.column_key = 'eventbridge://gold.test_schema/test_table/col1'  # change to eventbridge
    ...
    def test_transform_valid_only_type_struct(self) -> None:
        ...
        struct_type = StructTypeMetadata(name='col1',
                                         parent=column,
                                         type_str='struct<object>')
        inner_scalar_nest1 = ScalarTypeMetadata(name='value',
                                                parent=struct_type,
                                                type_str='object')

        struct_type.struct_items = {'value': inner_scalar_nest1, }
        inner_scalar_nest1.sort_order = 0
